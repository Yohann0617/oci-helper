...
public class AiChatHandler extends AbstractCallbackHandler {
    ...
    private String getModelDisplayName(String model) {
        ...
        } else if (model.contains("Qwen/Qwen3-8B")) {
            return "Qwen3-8B";
        } else if (model.contains("GLM-Z1-9B")) {
            return "GLM-Z1-9B";
...
class AiModelSelectionHandler extends AbstractCallbackHandler {
    ...
    public BotApiMethod<? extends Serializable> handle(CallbackQuery callbackQuery, TelegramClient telegramClient) {
        String text = "🤖 *选择 AI 模型*\n\n" +
                ...
                "• Qwen3-8B: 最新通义千问，综合能力强\n" +
                "• GLM-Z1-9B: 智谱推理模型，擅长逻辑推理";
        ...
        keyboard.add(new InlineKeyboardRow(
                KeyboardBuilder.button("🌟 Qwen3-8B", "ai_set_model_qwen3_8b")));

        keyboard.add(new InlineKeyboardRow(
                KeyboardBuilder.button("🔬 GLM-Z1-9B", "ai_set_model_glm_z1_9b")));
...
class AiSetModelHandler extends AbstractCallbackHandler {
    ...
    public BotApiMethod<? extends Serializable> handle(CallbackQuery callbackQuery, TelegramClient telegramClient) {
        ...
        } else if (callbackData.contains("qwen3_8b")) {
            modelName = "Qwen/Qwen3-8B";
            displayName = "Qwen3-8B";
        } else if (callbackData.contains("glm_z1_9b")) {
